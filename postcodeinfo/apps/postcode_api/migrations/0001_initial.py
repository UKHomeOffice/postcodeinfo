...
# because of known bug (#20656) in PostGIS 2.0+
# https://code.djangoproject.com/ticket/20656
# which prevents CREATE EXTENSION postgis being automatically run in
# migrations.
